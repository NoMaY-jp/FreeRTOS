...
#define init_bf u_uart1_init_bf
#define chk_status u_uart1_chk_status
#define get_data u_uart1_get_data
#define get_blk u_uart1_get_blk
#define g_rx_buff g_uart1_rx_buff
#define g_rx_rdpt g_uart1_rx_rdpt
#define g_rx_dtno g_uart1_rx_dtno
#define g_rx_status g_uart1_rx_status
#define uartx_callback_receivedata u_uart1_callback_receivedata
#define RX_BUFF_SIZE UART1_RX_BUFF_SIZE
#define RX_DTPT_MASK (UART1_RX_BUFF_SIZE - 1)
